        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var geoCoordMap = {
                    ...
                    '永兴佳园社区': [ 120.82283020019531,32.04395053011476],
                ...
                var introduction = "江苏省南通港闸经济开发区是1993年江苏省人民政府批准成立的省级开发区，经过几次区划调整，现有的开发区是由原来的永兴综合开发区、永兴乡、闸西乡、芦泾乡、天生港街道等五个乡镇街道合并而成，东至通吕运河，南至长江，西至九圩港，北至通扬运河，总面积40平方公里，户籍人口近10万人，下设永兴、天生港镇街道，下辖7个行政村、7个农村社区和8个城市社区居委会。";
    ...
    function loadXFMap() {
        $.ajax({
            ...
            success: function (data) {
                ...
                var introduction = "幸福街道位于港闸区东北部，南邻唐闸镇街道，西临陈桥街道，东北方向分别与通州区兴仁镇、刘桥镇接壤。总面积27.5平方公里，辖区人口3.8万人，其中户籍人口2.5万人，下辖十个村社区。幸福街道交通便利，东距南通兴东国际机场15公里，西距沪陕高速陈桥出口2.5公里，南通市火车站、在建的地铁二号线起点站均坐落辖区。";
                $('#introduction').empty().append(introduction);
            }
    ...
    function loadTZMap() {
        $.ajax({
            ...
            success: function (data) {
                ...
                var introduction = "唐闸镇街道于2005年8月由原闸东乡和唐闸镇合并而成，地处南通市北新城核心区，东起秦灶河，西到大生路，南临通吕运河，北至城北大道。辖区面积17.66平方公里，户籍人口4.8万余人，常住人口2.3万余人，下辖14个城市社区（分别为：永泰社区、怡园社区、新华社区、西洋桥社区、公园社区、大南社区、横河社区、新园社区、闸东社区、花墙社区、长岸社区、尖沟头社区、高店社区、碧林湾社区）。2018年，华润万象城、百安谊家进口馆等购物中心相继营业，景澜印象酒店入驻唐闸老镇，唐闸城市服务水平再上新台阶，已成为南通北翼发展的重要组团。";
                $('#introduction').empty().append(introduction);
            }
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var geoCoordMap = {
                    ...
                    '秦北村': [ 120.87235450744629,32.06890162700121],
                    '费桥村': [120.88394165039064,32.07101088295881],
                    '桥东村社区': [ 120.88359832763672,32.0518075861042],
                    '苏阳社区': [ 120.87055206298827, 32.0507163686643],
                    '秦灶社区': [120.86462974548338,32.05515390511265],
                    '民安花苑社区': [120.87286949157715, 32.04576935307218],
                    '八里庙村社区': [120.89484214782713, 32.0507163686643],
                    '桥北社区':[120.87733268737794, 32.05398998194655],
                    '袁桥村':[120.89501380920409,32.07021082608143],
                    '西安桥村':[120.9066867828369, 32.07464741690346]
                }
                var data = [
                    {
                        name: '袁桥村',
                ...
                var introduction = "秦灶街道，地处南通市区北翼，港闸区东部，南临通吕运河，具有“一城汇三区，一轴分两翼，一水绕八里”的独特区位优势，素有南通“北大门”之称。辖区总面积19.56平方公里，辖区人口近6万人，其中户籍人口约2.8万人。下辖秦北村、袁桥村、费桥村、西安桥村等4个行政村，桥东村社区、八里庙村社区等2个村社区以及苏阳社区、民安花苑社区、桥北社区、秦灶社区等4个城市社区。";
                $('#introduction').empty().append(introduction);
            }
